...
test.describe('Mobile Navigation - Hamburger Menu', () => {
  test.describe('Mobile Viewport (375px)', () => {
    ...
    test('should display mobile header with hamburger menu on mobile viewport', async ({
      page,
    }) => {
      await page.goto('/');
      ...
      await page.screenshot({
        path: './test-results/screenshots/01-mobile-initial.png',
        fullPage: true,
      });
      ...
      const mobileHeader = page
        .locator('header')
        .filter({ has: page.locator('button[aria-label="Open menu"]') });
    ...
    test('should open menu when hamburger icon is clicked', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/02-mobile-menu-open.png',
        fullPage: true,
      });
    ...
    test('should navigate and close menu when clicking a navigation link', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/03-mobile-after-nav.png',
        fullPage: true,
      });
    ...
    test('should close menu when clicking the X button', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/04-mobile-menu-closed.png',
        fullPage: true,
      });
    ...
    test('should close menu when clicking outside (overlay)', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/05-mobile-overlay-close.png',
        fullPage: true,
      });
    ...
    test('should highlight active navigation item', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/06-mobile-active-nav.png',
        fullPage: true,
      });
  ...
  test.describe('Tablet Viewport (768px)', () => {
    ...
    test('should still show hamburger menu on tablet viewport', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/07-tablet-initial.png',
        fullPage: true,
      });
      ...
      await page.screenshot({
        path: './test-results/screenshots/08-tablet-menu-open.png',
        fullPage: true,
      });
  ...
  test.describe('Desktop Viewport (1024px+)', () => {
    ...
    test('should show sidebar instead of hamburger menu on desktop', async ({ page }) => {
      ...
      await page.screenshot({
        path: './test-results/screenshots/09-desktop-initial.png',
        fullPage: true,
      });
    ...
    test('should navigate using sidebar on desktop', async ({ page }) => {
      ...
      // Screenshot after navigation
      await page.screenshot({
        path: './test-results/screenshots/10-desktop-after-nav.png',
        fullPage: true,
      });
